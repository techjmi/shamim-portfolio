...
export const hero_heading = `Hi, I'm ${candidate_name}`;
...
export const hero_cta_primary = { label: "View Projects", href: "#projects" };
export const hero_cta_secondary = { label: "Contact Me", href: "#contact" };
export const hero_cta_resume = { label: "Download Resume", href: about_resume };
...
export const hero_socials = [
  ...
  { type: "email", href: `mailto:${candidate_email}`, label: "Email" },
];
